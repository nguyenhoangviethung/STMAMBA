...
def parse_args():
    ...
    p.add_argument("--limit_train-batches", type=int, default=20, help="Limit number of training batches (for debugging)")
    p.add_argument("--limit_val-batches", type=int, default=2, help="Limit number of validation batches (for debugging)")
    return p.parse_args()
